...
from source.main import create_input
import os
from sklearn.metrics import precision_recall_curve
from matplotlib import pyplot as plt
from datetime import datetime
import numpy as np
from source.utils import ClozeMaskedNDCG
...
def evaluate(training,
    ...
    cloze_masked_ndcg = ClozeMaskedNDCG(k=5)

    model = tf.keras.models.load_model(
        filepath=saved_model_dir,
        compile=False,
        custom_objects={'ClozeMaskedNDCG': cloze_masked_ndcg}
    )
...
if __name__ == '__main__':
    saved_model_dir = '../training_output/run_14-Apr-08-52-57/savedmodel'

    training = '../data/amazon_beauty_bert4rec'
    validation = '../data/amazon_beauty_bert4rec'
